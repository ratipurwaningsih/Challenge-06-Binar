...
function Landing() {
  ...
  <header>
    <nav className="navbar navbar-expand-lg fixed-top pxc-7">
      <a className="navbar-brand ps-10 pe-4" href="#">
  ...
  <article id="home" className="row align-items-end">
    <div className="col home-content align-self-center">
      <h2 className="mb-5 font-weight-bold">Sewa &amp; Rental Mobil Terbaik di kawasan Brebes</h2>
  ...
  <article id="our-service" className="pxc-7 row align-items-center">
    ...
    <div className="col">
      <h3 className="font-weight-bold mb-4">Best Car Rental for any kind of trip in Brebes!</h3>
      <p className="mb-4">Sewa mobil di Brebes bersama Binar Car Rental jaminan harga lebih murah dibandingkan yang lain, kondisi mobil baru, serta kualitas pelayanan terbaik untuk perjalanan wisata, bisnis, wedding, meeting, dll.</p>
      <ul>
        <li>Sewa Mobil Dengan Supir di Brebes 12 Jam</li>
        <li>Sewa Mobil Lepas Kunci di Brebes 24 Jam</li>
  ...
  <article id="testimonial">
    ...
    <div id="banner-sewa" className="d-flex align-items-center justify-content-center pxc-7">
      <div className="container banner d-flex flex-column align-items-center">
        <h2 className="font-weight-bold mb-4 text-center">Sewa Mobil di Brebes Sekarang</h2>
  ...
  <footer id="footer" className="row">
    <div className="col pr-5">
      <p>Jalan Suroyo No. 161 Mayangan Kota Brebes 672000</p>
